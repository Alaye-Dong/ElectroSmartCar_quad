...
#define	IPS114_SCL_SIMSPI_PIN 		P63		//定义SPI_SCK引脚
#define	IPS114_SDA_SIMSPI_PIN		  P61   	//定义SPI_MOSI引脚
#define IPS114_REST_SIMSPI_PIN  	P71
#define IPS114_DC_SIMSPI_PIN 	 	  P67   	//液晶命令位引脚定义
#define IPS114_CS_SIMSPI_PIN    	P65   	//定义SPI_CS引脚
#define IPS114_BL_SIMSPI_PIN    	P47     //液晶背光引脚定义 
