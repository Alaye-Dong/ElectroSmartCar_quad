...
//=====================================================软件 IIC 驱动====================================================
	#define ICM20602_SCL_PIN   		P40				// 软件 IIC SCL 引脚P40
	#define ICM20602_SDA_PIN  		P41				// 软件 IIC SDA 引脚P41
	#define ICM20602_SOFT_IIC_DELAY	(0)
//=====================================================软件 IIC 驱动====================================================
#else
//=====================================================软件 SPI 驱动====================================================
	#define ICM20602_SPC_PIN        (P40)			// 软件 SPI SCK 引脚P40
	#define ICM20602_SDI_PIN        (P41)          	// 软件 SPI MOSI 引脚P41
	#define ICM20602_SDO_PIN        (P42)			// 软件 SPI MISO 引脚P42
	#define ICM20602_CS_PIN         (P43)			// 软件 SPI CS 引脚P43
//=====================================================软件 SPI 驱动====================================================
#endif
