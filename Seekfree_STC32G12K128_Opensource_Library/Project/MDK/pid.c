...
void Target_speed()
{ 	
		Target_speed1 = normal_speed - abs(v_angle)*0.13-abs(y_v_angle)*0.3- cha_err1*0.2;
		Target_speed2 = normal_speed - abs(v_angle)*0.13-abs(y_v_angle)*0.3+ cha_err1*0.2;
